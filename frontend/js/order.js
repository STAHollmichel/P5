async function orderRecap() {
    ...
    document.querySelector("#orderLine").innerHTML = `Nous vous remercions d'avoir choisi Orinoco pour vos achats. Votre commande d'un montant total de ${Order.contact.total} porte le numéro <strong>${Order.orderId}</strong>`;
